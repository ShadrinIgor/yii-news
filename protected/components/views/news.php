<div class="cItem listItems">
    ...
    <?php if( $values->country->id>0 ) : ?><a class="newsCid" title="<?= $values->country->name ?>, <?= $values->cid_id->name ?>" href="<?= SiteHelper::createUrl( "category/", array( "slug" =>$values->cid_id->key_word, "country"=>$values->country->key_word ) ) ?>"><?= $values->country->name ?></a>,<?php endif; ?>
    <a class="newsCid" title="<?= $values->cid_id->name ?>,<?= $values->country->name ?>" href="<?= SiteHelper::createUrl("category/", array( "slug"=>$values->cid_id->key_word ) ) ?>"><?= $values->cid_id->name ?></a><br>
