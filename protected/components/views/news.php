<div class="cItem listItems">
    ...
    <div class="TN_img"><div class="count_shows">Просмотров <?= $values->col ?></div><img alt="<?= $values->name ?> - Шоубиз Узбекистан" title="<?= $values->name ?> - Шоубиз Узбекистан" src="<?= ImageHelper::getCheckImage( $values->image ) ?> "></div>
